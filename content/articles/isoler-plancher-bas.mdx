...
- **Traiter l'humidité existante** : si la cave présente déjà des traces d'humidité, il convient d'agir à la source avant d'isoler ; nos repères pour [réduire l'humidité dans une cave](/maison/comment-reduire-humidite-cave) aident à identifier les bonnes actions.
