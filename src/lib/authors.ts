...
export const authors: Record<string, Author> = {
  "claire-deniau": {
    ...
    bio: "Journaliste habitat depuis quinze ans, Claire a couvert la rénovation, l'aménagement intérieur et la transition énergétique pour plusieurs magazines spécialisés.",
    avatar:
  ...
  "marc-aubert": {
    ...
    bio: "Ancien conducteur de travaux, Marc traduit le langage du chantier en conseils clairs pour les particuliers qui rénovent leur logement.",
    avatar:
  ...
  "lea-fontaine": {
    ...
    bio: "Passionnée de jardinage durable, Léa partage des méthodes d'entretien simples et respectueuses des plantes et des sols.",
    avatar:
  ...
  "thomas-reynaud": {
    ...
    bio: "Conseiller en rénovation énergétique, Thomas aide les ménages à réduire leur consommation sans sacrifier leur confort.",
    avatar:
  ...
  "sophie-marchand": {
    ...
    bio: "Architecte d'intérieur, Sophie défend une décoration intemporelle qui mise sur la lumière, les matières et l'harmonie des couleurs.",
    avatar:
